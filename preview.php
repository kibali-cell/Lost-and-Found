 ...
 <div class="main">
        ...
        <?php	
			include('config.php');
				...
				<div class="share-desc">
					...
					<div class="button"><span><a href="tel:<?php echo $row['ContactNumber']; ?>">Ask For Item</a></span></div>					
					<div class="clear"></div>
				</div>
				 <div class="wish-list">
				 	<ul>
   ...
   <div class="section group">
        ...
        <div class="copy_right">
				<p>© All rights Reseverd | <a href="http://github.com/kibali-cell">Jonas Kiwia</a> </p>
		   </div>
    </div>
   <script type="text/javascript">
		$(document).ready(function() {			
