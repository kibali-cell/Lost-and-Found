				...
				<div class="header_bg">
					<div class="wrap">
						<div class="header">
							...
							<div class="logo">
								<a href="home.php"><img src="images/logo1.png" alt="" style="height: 80px; object-fit: contain;" /></a>
							</div>	
							
							<div class="nav">
								<ul>
								   <li  class="active"><a href="logout.php" style="border-radius:8px;"><?php echo "<b>Logout  </b>(".$login_session.")"; ?></a></li>
	...
	<div class="wrap" id="portfolio">
			...
			<div class="gallery">
					...
					<ul id="filters" class="clearfix">
						<li><span class="filter active" data-filter="app card icon logo web" style="border-radius:10px;">Everything</span></li>
						<li><span class="filter" data-filter="app web" style="border-radius:10px;">Lost Something?</span></li>
						<li><span class="filter" data-filter="icon web card" style="border-radius:10px;">Found Something?</span></li>
...
<div class="contact" id="contact">
	<div class="wrap">
					...
					<div class="company_address">
						...
						<ul class="list3">
							...
							<li>
								...
								<div class="extra-wrap">
								<p> <a href="tel:+255748687340"> +255748687340 </a></p>
								</div>
								<div class="clear"> </div>
							</li>
							<li>
								...
								<div class="extra-wrap">
								<p> <a href="tel:+255624647340"> +255624647340 </a></p>
								</div>
								<div class="clear"> </div>
							</li>
							<li>
								...
								<div class="extra-wrap">
									<p> <a href="mailto:jonaskiwia1@gmail.com"> Official Email</a></p>
								</div>
								<div class="clear"> </div>
							</li>
						</ul>
     ...
     <div class="footer-bottom">
     	<div class="wrap">
        <div class="copy">
		    <p class="copy">&#169 2023  <a href="http://github.com/kibali-cell" target="_blank"> | Jonas Kiwia</a> </p>
		</div>
		<script type="text/javascript">
							$(document).ready(function() {
